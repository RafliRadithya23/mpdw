...
Pemilihan data training & testing dilakukan pada data yang ada dengan proporsi 80% data training dan 20% data testing. Adapun pengambilan nilai frekuensi disesuaikan pada pola data yang berulang setiap 400 periode
...
3.  Plot Time Series
    ...
    Berdasarkan hasil pemulusan menggunakan metode Holt-Winters pada data training, sebagian besar kurva pemulusannya winter1.opt berhimpitan pada kurva data training atau dengan kata lain kurva pemulusannya hampir mirip dengan kurva data training dibandingkan kurva pemulusan winter1.
